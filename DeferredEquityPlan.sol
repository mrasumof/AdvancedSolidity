...
contract DeferredEquityPlan {
    ...
    function distribute() public {
        ...
        require(unlock_time <= fakenow, "Contract Locked.");
        // 2: `distributed_shares` is less than the `total_shares`
        require(distributed_shares < total_shares,"Distributed Shares should be less than total number of shares.");
        ...
        distributed_shares = (fakenow - start_time)/365 days;
